...
@section('title', 'Crear Departamento - Sistema de Gestión')
    ...
    <div class="card-body">
        ...
        <form method="POST" action="{{ route('departamentos.store') }}">
            ...
            <div class="form-group">
                ...
                <input type="text" id="nombre" name="nombre" class="form-control @error('nombre') is-invalid @enderror" value="{{ old('nombre') }}" required autofocus>
                @error('nombre')
