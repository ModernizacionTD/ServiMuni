...
@section('title', 'Editar Usuario - ServiMuni')
...
<div class="form-view-container">
    <div class="card">
        ...
        <div class="form-card-body">
            ...
            <form method="POST" action="{{ route('usuarios.update', $usuario['rut']) }}" id="userEditForm" novalidate>
                @csrf
                @method('PUT')
                        ...
                        <div class="form-col-2">
                            <div class="form-group">
                                ...
                                <select id="tipo_persona" 
                                    ...
                                    <option value="Natural" {{ old('tipo_persona', $usuario['tipo_persona']) == 'Natural' ? 'selected' : '' }}>
                                        <i class="fas fa-user"></i> Persona Natural
                                    </option>
                                    <option value="Jurídica" {{ old('tipo_persona', $usuario['tipo_persona']) == 'Jurídica' ? 'selected' : '' }}>
                ...
                <div id="camposPersonaNatural" class="form-section" style="{{ old('tipo_persona', $usuario['tipo_persona']) == 'Natural' ? 'display: block;' : 'display: none;' }}">
                    <h3 class="form-section-title">
                    ...
                    <div class="form-row">
                        <div class="form-col-2">
                            <div class="form-group">
                                ...
                                <select id="uso_ns" 
                                        ...
                                        required>
                                    <option value="No" {{ old('uso_ns', $usuario['uso_ns'] ?? 'No') == 'No' ? 'selected' : '' }}>No</option>
                        ...
                        <div class="form-col-2" id="campoNombreSocial" style="{{ old('uso_ns', $usuario['uso_ns']) == 'Sí' ? 'display: block;' : 'display: none;' }}">
                            <div class="form-group">
                ...
                <div id="camposPersonaJuridica" class="form-section" style="{{ old('tipo_persona', $usuario['tipo_persona']) == 'Jurídica' ? 'display: block;' : 'display: none;' }}">
                    <h3 class="form-section-title">
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    tipoPersonaSelect.addEventListener('change', function() {
        ...
        if (tipoPersona === 'Natural') {
            ...
            // Quitar required del nombre jurídico
            ...
            // Limpiar campos visibles de persona natural (pero mantener valores en inputs ocultos)
    ...
    // Auto-focus en el primer campo editable (telefono, ya que RUT generalmente no se edita)
