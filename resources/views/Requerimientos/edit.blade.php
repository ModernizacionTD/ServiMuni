...
@section('title', 'Editar Requerimiento - ServiMuni')
    ...
    <div class="card">
        <div class="form-card-header">
            <h2 class="form-card-title">
                <i class="fas fa-clipboard-list"></i>Editar Requerimiento
            </h2>
        ...
        <div class="form-card-body">
            ...
            <form method="POST" action="{{ route('requerimientos.update', $requerimiento['id_requerimiento']) }}" id="requerimientoEditForm" novalidate>
                @csrf
                @method('PUT')
                            ...
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="text" 
                                           ...
                                           value="{{ old('nombre', $requerimiento['nombre']) }}" 
                                ...
                                <div class="form-text">
                                    <i class="fas fa-info-circle"></i>
                                    Máximo 30 caracteres. <span id="nombreCount">{{ strlen(old('nombre', $requerimiento['nombre'])) }}</span>/30
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="input-group">
                            ...
                            <textarea id="descripcion_req" 
                                      ...
                                      maxlength="255"
                                      required>{{ old('descripcion_req', $requerimiento['descripcion_req']) }}</textarea>
                        </div>
                        ...
                        <div class="form-text">
                            <i class="fas fa-info-circle"></i>
                            Máximo 255 caracteres. <span id="descripcionReqCount">{{ strlen(old('descripcion_req', $requerimiento['descripcion_req'])) }}</span>/255
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="input-group">
                            ...
                            <textarea id="descripcion_precio" 
                                      ...
                                      maxlength="255"
                                      required>{{ old('descripcion_precio', $requerimiento['descripcion_precio']) }}</textarea>
                        </div>
                        ...
                        <div class="form-text">
                            <i class="fas fa-info-circle"></i>
                            Máximo 255 caracteres. <span id="descripcionPrecioCount">{{ strlen(old('descripcion_precio', $requerimiento['descripcion_precio'])) }}</span>/255
                        </div>
                    </div>
                </div>
                            ...
                            <div class="form-group">
                                <div class="form-check form-switch">
                                    <input type="checkbox" 
                                           ...
                                           value="1" 
                                           {{ old('privado', $requerimiento['privado']) ? 'checked' : '' }}>
                            ...
                            <div class="form-group">
                                <div class="form-check form-switch">
                                    <input type="checkbox" 
                                           ...
                                           value="1" 
                                           {{ old('publico', $requerimiento['publico']) ? 'checked' : '' }}>
                ...
                <div class="form-actions">
                    ...
                    <button type="submit" class="form-btn form-btn-primary" id="submitBtn">
                        ...
                        <span>Actualizar Requerimiento</span>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    const form = document.getElementById('requerimientoEditForm');
    ...
    function updateAccessMessage() {
        ...
        if (isPrivado && isPublico) {
            ...
            accessAlert.style.display = 'block';
            accessMessage.textContent = 'El requerimiento no tiene configuración de acceso. Se recomienda seleccionar al menos una opción.';
            accessAlert.className = 'form-alert form-alert-warning';
        }
    }
    ...
    form.addEventListener('submit', function(e) {
        ...
        console.log('Enviando formulario de edición de requerimiento...');
        ...
        // Validar que al menos una opción de acceso esté seleccionada
        if (!privadoCheckbox.checked && !publicoCheckbox.checked) {
            // Mostrar advertencia pero no impedir el envío
...
<style>
/* Estilos específicos para formulario de edición de requerimientos */
.form-card-header {
